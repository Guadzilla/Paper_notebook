...
try:
    ...
    relation_matrix = Relation(user_train, usernum, args.maxlen, args.time_span)    # 保存所有用户的relation矩阵，下一条语句用于保存
...
for epoch in range(epoch_start_idx, args.num_epochs + 1):
    ...
    for step in range(num_batch): # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
        ...
        pos_logits, neg_logits = model(u, seq, time_matrix, pos, neg)   # 正负例的logits得分
